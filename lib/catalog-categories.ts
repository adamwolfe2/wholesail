...
export const catalogCategories: CatalogCategory[] = [
  {
    ...
    name: "Truffles",
    dbCategory: "Truffles",
    title: "Wholesale Truffles — Black & White Truffle Supplier | TBGC",
    ...
    body: "TBGC sources fresh black and white truffles directly from Périgord, Alba, and the Pacific Northwest — available for same-day delivery across SoCal and 24-48hr nationwide. We supply Michelin-starred kitchens, luxury hotels, and private chefs with the freshest seasonal truffles available.",
  ...
  },
  {
    ...
    name: "Caviar",
    dbCategory: "Caviar",
    title: "Wholesale Caviar — Kaluga, Osetra & Sturgeon Supplier | TBGC",
    ...
    body: "From Kaluga Hybrid 000 to Osetra and beyond, TBGC carries the full premium caviar spectrum. All caviar ships cold-chain — insulated packaging with ice packs — to preserve the bead integrity and flavor profile your program demands.",
  ...
  },
  {
    ...
    title: "Wholesale A5 Wagyu & Premium Proteins | TBGC",
    ...
    body: "Authentic A5 Japanese Wagyu from Miyazaki, Kagoshima, and Hokkaido — verified grade with BMS 8-12 marbling. TBGC handles cold-chain logistics so your striploin and ribeye arrive at the exact temperature needed for your program.",
  ...
  },
  {
    ...
    title: "Wholesale Foie Gras & Duck — Grade A Supplier | TBGC",
    ...
    body: "TBGC carries Grade A whole lobe foie gras, Hudson Valley duck, magret, and duck confit — the full program for any serious kitchen. All duck and foie products ship cold-chain. We supply chefs across the country (note: foie gras ships to all states except California).",
  ...
  },
  {
    ...
    title: "Wholesale Italian Salumi & Charcuterie | TBGC",
    ...
    body: "From bison salami to imported Italian prosciutto and artisan coppa, TBGC's charcuterie selection covers every program need. Hand-selected from the best producers — consistent quality, reliable availability.",
  ...
  },
  {
    ...
    title: "Wholesale Specialty Coffee & Premium Tea | TBGC",
    ...
    body: "TBGC's coffee and tea selection is curated for hospitality programs that don't compromise — specialty-grade coffee and ceremonial matcha alongside premium teas for dining room service.",
