        ...
        <div className="mx-auto px-4 py-6 sm:px-6 sm:py-8 lg:px-10 max-w-7xl space-y-6">
          ...
          <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
            <div className="space-y-2">
              <Skeleton className="h-8 w-40 bg-[#C8C0B4]/20" />
              <Skeleton className="h-4 w-64 bg-[#C8C0B4]/20" />
            </div>
            <Skeleton className="h-10 w-24 bg-[#C8C0B4]/20" />
          </div>

          {/* Filter skeletons */}
          <div className="flex flex-col sm:flex-row gap-3">
            <Skeleton className="h-10 flex-1 bg-[#C8C0B4]/20" />
            <Skeleton className="h-10 w-full sm:w-[220px] bg-[#C8C0B4]/20" />
          </div>

          {/* Product count */}
          <Skeleton className="h-3 w-32 bg-[#C8C0B4]/20" />
