...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: `${entry.name} — Provenance & Sourcing | TBGC`,
    description,
    openGraph: {
      title: `${entry.name} — Provenance & Sourcing | TBGC`,
      description,
      type: 'article',
      images: [{ url: '/Public Social Image.png', width: 1731, height: 966, alt: `${entry.name} — Truffle Boys & Girls Club` }],
    },
    twitter: {
    ...
    alternates: {
      canonical: `https://truffleboys.com/provenance/${entry.slug}`,
    },
  }
}
