      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Skeleton className="h-20 w-full" style={{ background: 'var(--color-shell)' }} />
          </div>
        </CardContent>
      </Card>
      <Card>
        ...
        <CardContent className="space-y-3">
          {Array.from({ length: 3 }).map((_, i) => (
            <div key={i} className="flex items-center gap-4">
              ...
              <Skeleton className="h-9 w-20" style={{ background: 'var(--color-shell)' }} />
              <Skeleton className="h-9 w-20" style={{ background: 'var(--color-shell)' }} />
              <Skeleton className="h-9 w-9" style={{ background: 'var(--color-shell)' }} />
            </div>
          ))}
        </CardContent>
      </Card>
