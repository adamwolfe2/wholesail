        ...
        {Array.from({ length: 3 }).map((_, i) => (
          <Card key={i}>
            ...
            <CardContent className="space-y-3">
              <Skeleton className="h-8 w-20" style={{ background: '#E5E1DB' }} />
              <Skeleton className="h-3.5 w-32" style={{ background: '#E5E1DB' }} />
              <Skeleton className="h-3.5 w-28" style={{ background: '#E5E1DB' }} />
            </CardContent>
          </Card>
        ))}
      </div>
        ...
        <CardContent className="pt-6">
          {Array.from({ length: 6 }).map((_, i) => (
            <div key={i} className="flex items-center gap-4 py-3 border-b last:border-0">
              <Skeleton className="h-4 w-24" style={{ background: '#E5E1DB' }} />
              <Skeleton className="h-4 w-36" style={{ background: '#E5E1DB' }} />
