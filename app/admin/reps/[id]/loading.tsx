  ...
  return (
    <div className="space-y-6 max-w-4xl">
      ...
      <div className="flex items-center gap-4">
        <Skeleton className="h-16 w-16 rounded-full" style={{ background: '#E5E1DB' }} />
        <div>
          <Skeleton className="h-8 w-40" style={{ background: '#E5E1DB' }} />
          <Skeleton className="h-4 w-48 mt-2" style={{ background: '#E5E1DB' }} />
        </div>
      </div>
      {/* Stat cards */}
        ...
        {Array.from({ length: 3 }).map((_, i) => (
          <Card key={i}>
            <CardContent className="pt-4">
              <Skeleton className="h-3.5 w-20 mb-2" style={{ background: '#E5E1DB' }} />
              <Skeleton className="h-7 w-16" style={{ background: '#E5E1DB' }} />
            </CardContent>
          </Card>
        ))}
      </div>
