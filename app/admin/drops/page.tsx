    ...
    <div className="space-y-6">
      ...
      <div className="flex items-start justify-between">
        ...
        <Link
          href="/drops"
          target="_blank"
          className="text-xs text-[#0A0A0A]/50 hover:text-[#0A0A0A] transition-colors border border-[#E5E1DB] px-3 py-1.5 hover:border-[#0A0A0A]/40"
        >
          View public page ↗
        </Link>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-3">
        <Card className="border-[#E5E1DB] bg-[#F9F7F4]">
          ...
          <CardContent>
            ...
            <p className="text-xs text-[#0A0A0A]/40 mt-1">All scheduled</p>
          </CardContent>
        </Card>
        ...
        <Card className="border-[#E5E1DB] bg-[#F9F7F4]">
          <CardHeader className="flex flex-row items-center justify-between pb-2">
            ...
            <Eye className="h-4 w-4 text-[#C8C0B4]" />
          </CardHeader>
          <CardContent>
            <div className="text-3xl font-bold font-serif text-[#0A0A0A]">{stats.publicCount}</div>
            <p className="text-xs text-[#0A0A0A]/40 mt-1">Visible on drops page</p>
          </CardContent>
        </Card>
        ...
        <Card className="border-[#E5E1DB] bg-[#F9F7F4]">
          ...
          <CardContent>
            <div className="text-3xl font-bold font-serif text-[#0A0A0A]">{stats.totalSignups}</div>
            <p className="text-xs text-[#0A0A0A]/40 mt-1">Across all drops</p>
          </CardContent>
        </Card>
      </div>
