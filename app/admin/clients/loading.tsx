  ...
  return (
    <div className="space-y-6">
      ...
      <div className="border border-shell">
        {/* Table header */}
        <div className="px-4 py-3 border-b border-shell grid grid-cols-5 gap-4">
          ...
          <Skeleton className="h-3 w-14" style={{ background: 'var(--color-shell)' }} />
        ...
        {Array.from({ length: 8 }).map((_, i) => (
          <div
            key={i}
            className="px-4 py-3 border-b border-shell grid grid-cols-5 gap-4 items-center last:border-0"
          >
