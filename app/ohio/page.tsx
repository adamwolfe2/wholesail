    ...
    <div className="min-h-screen" style={{ backgroundColor: "var(--bg-primary)" }}>
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6">
        <section className="py-20 sm:py-28" style={{ borderBottom: "1px solid var(--border)" }}>
          ...
          >
            For Ohio Wholesale Distributors
          </span>
          <h1
            className="font-serif text-4xl sm:text-5xl lg:text-6xl font-normal leading-[1.1] mb-6 max-w-3xl"
            style={{ color: "var(--text-headline)" }}
          >
            Ohio&apos;s manufacturing and food industries are your best accounts.
            <br />
            <span style={{ color: "var(--blue)" }}>Give them the ordering experience they get from every other supplier.</span>
          </h1>
          <p
            className="font-mono text-sm leading-relaxed max-w-xl mb-10"
            style={{ color: "var(--text-body)" }}
          >
            Wholesail builds custom B2B ordering portals for Ohio food, industrial, and manufacturing supply
          ...
          <p
            ...
            style={{ color: "var(--text-muted)" }}
          >
            Ohio ranks 7th nationally in wholesale trade volume, with strength in food, industrial, and consumer goods.
          </p>
        </section>
        ...
        <section className="py-16" style={{ borderBottom: "1px solid var(--border)" }}>
          ...
          >
            ...
            <blockquote
              ...
              style={{ color: "var(--text-body)" }}
            >
              We distribute specialty food and packaging supplies to manufacturers and food producers across central Ohio. Our accounts are professional operations — they expect their suppliers to run the same way. Wholesail gave us a portal that matches that expectation. Orders are organized, pricing is automatic, and we&apos;re no longer fielding calls just to tell people what&apos;s in stock.
            </blockquote>
            <div>
              <div className="font-mono text-[11px] font-semibold" style={{ color: "var(--text-headline)" }}>Tom W.</div>
              <div className="font-mono text-[10px]" style={{ color: "var(--text-muted)" }}>Heartland Supply Partners</div>
              <div className="font-mono text-[9px] uppercase tracking-wider mt-1" style={{ color: "var(--text-muted)" }}>Food & Industrial Distribution — Central Ohio</div>
            </div>
          </div>
        </section>
