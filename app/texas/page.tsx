    ...
    <div className="min-h-screen" style={{ backgroundColor: "var(--bg-primary)" }}>
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6">
        <section className="py-20 sm:py-28" style={{ borderBottom: "1px solid var(--border)" }}>
          ...
          >
            For Texas Wholesale Distributors
          </span>
          <h1
            className="font-serif text-4xl sm:text-5xl lg:text-6xl font-normal leading-[1.1] mb-6 max-w-3xl"
            style={{ color: "var(--text-headline)" }}
          >
            Texas distribution runs on relationships. Your relationships deserve better tools than a shared spreadsheet.
            <br />
            <span style={{ color: "var(--blue)" }}>Give your accounts a portal that reflects the size of your operation.</span>
          </h1>
          <p
            className="font-mono text-sm leading-relaxed max-w-xl mb-10"
            style={{ color: "var(--text-body)" }}
          >
            Wholesail builds custom B2B ordering portals for Texas food, beverage, and industrial supply distributors.
          ...
          <p
            ...
            style={{ color: "var(--text-muted)" }}
          >
            Texas is the 2nd largest wholesale distribution market in the US, with $400B+ in annual wholesale revenue.
          </p>
        </section>
        ...
        <section className="py-16" style={{ borderBottom: "1px solid var(--border)" }}>
          ...
          >
            ...
            <blockquote
              ...
              style={{ color: "var(--text-body)" }}
            >
              We cover the whole Dallas-Fort Worth metroplex — over 200 restaurant and food service accounts. Managing orders by phone and email was killing our operations team. With Wholesail, our accounts just log in and order. We see everything in real time, fulfillment is cleaner, and our reps are focused on growing accounts instead of entering orders they already took.
            </blockquote>
            <div>
              <div className="font-mono text-[11px] font-semibold" style={{ color: "var(--text-headline)" }}>James H.</div>
              <div className="font-mono text-[10px]" style={{ color: "var(--text-muted)" }}>Lone Star Provisions Group</div>
              <div className="font-mono text-[9px] uppercase tracking-wider mt-1" style={{ color: "var(--text-muted)" }}>Food & Beverage Distribution — Dallas-Fort Worth</div>
            </div>
          </div>
        </section>
