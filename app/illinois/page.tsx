    ...
    <div className="min-h-screen" style={{ backgroundColor: "var(--bg-primary)" }}>
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6">
        <section className="py-20 sm:py-28" style={{ borderBottom: "1px solid var(--border)" }}>
          ...
          >
            For Illinois Wholesale Distributors
          </span>
          <h1
            className="font-serif text-4xl sm:text-5xl lg:text-6xl font-normal leading-[1.1] mb-6 max-w-3xl"
            style={{ color: "var(--text-headline)" }}
          >
            Chicago&apos;s food scene orders on their schedule, not yours.
            <br />
            <span style={{ color: "var(--blue)" }}>Stop missing orders that come in after 5pm.</span>
          </h1>
          <p
            className="font-mono text-sm leading-relaxed max-w-xl mb-10"
            style={{ color: "var(--text-body)" }}
          >
            Wholesail builds custom B2B ordering portals for Illinois food, beverage, and industrial supply
          ...
          <p
            ...
            style={{ color: "var(--text-muted)" }}
          >
            The Chicago metro area is the 3rd largest food distribution hub in the United States.
          </p>
        </section>
