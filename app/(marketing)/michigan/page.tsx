    ...
    <div className="min-h-screen" style={{ backgroundColor: "var(--bg-primary)" }}>
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6">
        <section className="py-20 sm:py-28" style={{ borderBottom: "1px solid var(--border)" }}>
          ...
          >
            For Michigan Wholesale Distributors
          </span>
          <h1
            className="font-serif text-4xl sm:text-5xl lg:text-6xl font-normal leading-[1.1] mb-6 max-w-3xl"
            style={{ color: "var(--text-headline)" }}
          >
            Michigan runs on manufacturing. Your accounts need to reorder faster than a phone call allows.
            <br />
            <span style={{ color: "var(--blue)" }}>Give them a portal built for the supply chain.</span>
          </h1>
          <p
            className="font-mono text-sm leading-relaxed max-w-xl mb-10"
            style={{ color: "var(--text-body)" }}
          >
            Wholesail builds custom B2B ordering portals for Michigan auto parts, food/beverage, industrial supply, and
            building materials distributors. Your accounts in Detroit, Grand Rapids, Lansing, Ann Arbor, and Flint order
            online 24/7 — no phone call, no voicemail, no rep required. Every order lands in your dashboard the moment
            it&apos;s placed. Live in under 2 weeks.
          </p>
          ...
          <p
            ...
            style={{ color: "var(--text-muted)" }}
          >
            Michigan is home to the most concentrated manufacturing supply chain in North America — and your accounts expect a buying experience that matches that pace.
          </p>
        </section>
        ...
        <section className="py-16" style={{ borderBottom: "1px solid var(--border)" }}>
          ...
          >
            ...
            <blockquote
              ...
              style={{ color: "var(--text-body)" }}
            >
              We distribute food and beverage to about 90 restaurants and grocery accounts across metro Detroit and Grand Rapids. Our reps were spending most of their day fielding reorder calls and fixing order mistakes. Wholesail changed that completely — accounts log in, reorder in two minutes, and we actually get to focus on new business again.
            </blockquote>
            <div>
              <div className="font-mono text-[11px] font-semibold" style={{ color: "var(--text-headline)" }}>Marcus T.</div>
              <div className="font-mono text-[10px]" style={{ color: "var(--text-muted)" }}>Great Lakes Provisions</div>
              <div className="font-mono text-[9px] uppercase tracking-wider mt-1" style={{ color: "var(--text-muted)" }}>Food & Beverage Distribution — Southeast Michigan</div>
            </div>
          </div>
        </section>
