    ...
    <div className="min-h-screen bg-cream">
      ...
      <section className="pt-24 pb-16 sm:pt-32 sm:pb-20 border-b border-shell">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-ink/55 text-base sm:text-lg leading-relaxed max-w-xl">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-px bg-shell">
            {articles.map(article => (
              <Link
                ...
                className="bg-cream p-8 sm:p-10 flex flex-col justify-between min-h-[300px] group hover:bg-white transition-colors"
              >
                <div>
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <p className="text-[10px] text-sand">{article.readTime}</p>
                  </div>
                  <h2 className="font-serif text-xl sm:text-2xl font-bold text-ink leading-tight mb-4">
                    {article.title}
                  </h2>
                ...
                <div className="mt-8 pt-4 border-t border-shell flex items-center justify-between">
                  ...
                  <p className="text-[10px] tracking-wider uppercase text-sand group-hover:text-ink flex items-center gap-1 transition-colors">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h2 className="font-serif text-3xl sm:text-4xl font-bold text-ink mb-5">
                Follow the Feed.
              </h2>
              <p className="text-ink/55 text-sm leading-relaxed mb-8 max-w-md">
            ...
            <div className="border border-shell bg-white p-10 sm:p-14 text-center">
              <p className="font-serif text-6xl font-bold text-ink/10 mb-4 italic">46K</p>
