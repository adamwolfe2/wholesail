...
export default async function DropPage({ params }: Props) {
  ...
  return (
    <div className="min-h-screen bg-cream">
      ...
      {/* BREADCRUMB */}
      <div className="border-b border-shell bg-white">
      ...
      {/* HERO */}
      <section className="pt-12 pb-12 sm:pt-16 sm:pb-16 border-b border-shell">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
          ...
          <h1 className="font-serif text-4xl sm:text-5xl lg:text-6xl font-bold leading-[1.05] text-ink mb-8">
            {drop.title}
          </h1>
          ...
          <div className="flex flex-wrap items-center gap-6 mb-8">
            ...
            <div className="flex items-center gap-2 text-sm">
              ...
              <span className={isPast ? 'text-sand' : 'text-ink font-medium'}>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-px bg-shell">
            <div className="bg-cream p-8 sm:p-10">
              ...
              <Link
                href="/partner"
                className="inline-flex items-center gap-2 border border-ink text-ink px-6 py-3 text-sm font-medium hover:bg-ink hover:text-cream transition-colors"
              >
                Apply for Wholesale
      ...
      <footer className="border-t border-shell bg-ink-dark text-cream py-10">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-6 text-sm text-cream/40">
            ...
            <Link href="/drops" className="hover:text-cream transition-colors">Drops</Link>
