...
export const metadata: Metadata = {
  title: "Standing Orders for Wholesale Distribution | Wholesail",
  description:
    "Wholesail automates standing and recurring orders for wholesale distributors. Your restaurant accounts keep ordering the same items every week — stop having your team enter that manually.",
  openGraph: {
    title: "Standing Orders for Wholesale Distribution | Wholesail",
    description:
      "The average food distributor has 60–70% of weekly volume on recurring orders. Wholesail automates standing orders so accounts self-manage their own recurring schedule.",
  },
  alternates: { canonical: "https://wholesailhub.com/features/standing-orders" },
};

const PAIN_POINTS = [
  {
    before: "A restaurant orders the same 15 items every Tuesday. Your rep takes the call, writes it down, and enters it manually. This happens every single week without variation.",
    after: "The account sets up their standing order once. It runs on their schedule automatically and appears in your fulfillment dashboard without anyone touching it.",
  },
  {
    before: "When a rep is sick, on vacation, or just busy, standing orders get missed or delayed. The account calls to ask where their order is.",
    after: "Standing orders are independent of your reps. They run on schedule whether your rep is in the office or not. Accounts never wonder where their order is.",
  },
  {
    before: "Accounts call to add a one-time item to their standing order. This is an interruption for your team every time it happens.",
    after: "Accounts log into their portal, add to or modify their standing order themselves, and submit. No call required.",
  },
  {
    before: "Tracking which accounts have standing arrangements, what they&apos;re getting, and when it runs lives in a spreadsheet or in someone&apos;s head.",
    after: "Every standing order is visible in your admin dashboard — schedule, items, account, and last-run status — all in one place.",
  },
];

const FEATURES = [
  "Per-account standing order setup with weekly, biweekly, and custom schedule options",
  "Accounts can view, edit, and pause their own standing order from their portal",
  "One-time order additions layered on top of standing order runs",
  "Admin dashboard view of all active standing orders and upcoming run dates",
  "Automatic order generation — standing orders appear in fulfillment without manual entry",
  "Email and SMS confirmation sent to accounts when their standing order processes",
  "Standing order history so accounts can reference past deliveries without calling",
  "Pause and resume controls for accounts who need to skip a week",
  "Minimum order enforcement applied automatically on standing order runs",
];
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6">
        <section className="py-20 sm:py-28" style={{ borderBottom: "1px solid var(--border)" }}>
          ...
          <h1
            ...
            style={{ color: "var(--text-headline)" }}
          >
            Your restaurant accounts order the same 15 items every Tuesday.
            <br />
            <span style={{ color: "var(--blue)" }}>Why is your rep entering that order manually every single week?</span>
          </h1>
          <p
            className="font-mono text-sm leading-relaxed max-w-xl mb-10"
            style={{ color: "var(--text-body)" }}
          >
            Wholesail&apos;s standing order system lets your accounts set up their own recurring order schedule.
            They place it once. It runs automatically. Every order appears in your fulfillment dashboard on time,
            without a phone call, without a rep, without manual entry. Live in under 2 weeks.
          </p>
          ...
          <p
            ...
            style={{ color: "var(--text-muted)" }}
          >
            The average food distributor has 60–70% of weekly volume on standing or recurring orders.
          </p>
        </section>
        ...
        <section className="py-16" style={{ borderBottom: "1px solid var(--border)" }}>
          ...
          <h2
            ...
            style={{ color: "var(--text-headline)" }}
          >
            What changes when standing orders run themselves.
          </h2>
          <div
        ...
        <section className="py-16" style={{ borderBottom: "1px solid var(--border)" }}>
          ...
          >
            ...
            <blockquote
              ...
              style={{ color: "var(--text-body)" }}
            >
              About 65% of our weekly order volume was the same accounts ordering the same things. Our rep was spending half her week re-entering orders that didn&apos;t change. Wholesail&apos;s standing order feature automated all of that. Those orders just show up in our dashboard now. She uses that time to actually sell. We&apos;ve grown the account base 30% since we launched and didn&apos;t need to hire anyone.
            </blockquote>
            <div>
              <div className="font-mono text-[11px] font-semibold" style={{ color: "var(--text-headline)" }}>Patricia N.</div>
              <div className="font-mono text-[10px]" style={{ color: "var(--text-muted)" }}>NorthShore Specialty Foods</div>
        ...
        <section className="py-16" style={{ borderBottom: "1px solid var(--border)" }}>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-0" style={{ border: "1px solid var(--border-strong)" }}>
            {[
              {
                stat: "60–70%",
                label: "of weekly order volume at the average food distributor is standing or recurring orders placed by the same accounts",
                source: "IFDA Distribution Performance Report, 2024",
              },
              {
                stat: "3–4 hrs",
