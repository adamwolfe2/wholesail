...
export const metadata: Metadata = {
  ...
  description:
    "Wholesail gives your wholesale accounts a full order history portal and one-click reorder — so they stop calling your reps to ask what they ordered last time.",
  openGraph: {
    title: "Order History & Reorder for Wholesale Distributors | Wholesail",
    description:
      "Every past order, searchable, downloadable, and one-click reorderable — directly in your accounts' portal. Stop having your reps dig through spreadsheets to answer the same question every week.",
  },
  alternates: { canonical: "https://wholesailhub.com/features/order-history" },
};

const PAIN_POINTS = [
  {
    before: "Accounts call your reps at least once a week to ask what they ordered last time. Your rep digs through emails, spreadsheets, or order entry software trying to find the answer.",
    after: "Accounts log into their portal, see every past order with full line-item detail, and find what they need in under 30 seconds. The call never happens.",
  },
  {
    before: "Reordering means recreating the same order from scratch. The account calls, lists every item again, and your rep re-enters it. The same work happens every cycle.",
    after: "Accounts click Reorder on any past order. Items populate their cart instantly. They adjust quantities if needed and submit. No call. No re-entry. No wasted time on either side.",
  },
  {
    before: "Reps have no visibility into account order patterns. They can't tell which accounts are ordering less, which are growing, or when to reach out about a gap.",
    after: "Your admin dashboard shows order history and frequency by account. Reps see patterns, spot gaps, and reach out before an account quietly moves to a competitor.",
  },
  {
    before: "When an account has a billing or delivery dispute, tracing what was ordered, when, and at what price means hunting through multiple systems and hoping records are intact.",
    after: "Every order is logged with full detail — items, quantities, pricing, delivery date, and confirmation. Disputes resolve in minutes, not hours.",
  },
];

const FEATURES = [
  "Full order history per account, visible directly in their portal",
  "One-click reorder from any past order with quantity editing",
  "Order search and filter by date range, product, or order number",
  "Downloadable order history in CSV or PDF format",
  "Account-facing delivery tracking history by order",
  "Admin view of all account order history and frequency patterns",
  "Rep-facing account order summary to spot gaps and trends",
  "Order detail pages with line items, pricing, and delivery confirmation",
  "Reorder with modifications — add, remove, or adjust items before submitting",
];
    ...
    <div className="min-h-screen" style={{ backgroundColor: "var(--bg-primary)" }}>
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6">
        <section className="py-20 sm:py-28" style={{ borderBottom: "1px solid var(--border)" }}>
          ...
          >
            Wholesale Order History & Reorder
          </span>
          <h1
            className="font-serif text-4xl sm:text-5xl lg:text-6xl font-normal leading-[1.1] mb-6 max-w-3xl"
            style={{ color: "var(--text-headline)" }}
          >
            Your accounts call to ask &ldquo;what did we order last time?&rdquo; at least once a week.
            <br />
            <span style={{ color: "var(--blue)" }}>Stop answering that question.</span>
          </h1>
          <p
            className="font-mono text-sm leading-relaxed max-w-xl mb-10"
            style={{ color: "var(--text-body)" }}
          >
            Wholesail gives every account a full, searchable order history in their portal — and one-click reorder
            from any past order. Accounts stop calling. Reps stop digging. Orders come in faster.
        ...
        <section className="py-16" style={{ borderBottom: "1px solid var(--border)" }}>
          ...
          <h2
            ...
            style={{ color: "var(--text-headline)" }}
          >
            What changes when accounts can see their own history.
          </h2>
          <div
        ...
        <section className="py-16" style={{ borderBottom: "1px solid var(--border)" }}>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-0" style={{ border: "1px solid var(--border-strong)" }}>
            {[
              {
                stat: "70%",
                label: "of repeat B2B orders are placed using a previous order as the reference point",
