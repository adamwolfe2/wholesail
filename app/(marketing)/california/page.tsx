    ...
    <div className="min-h-screen" style={{ backgroundColor: "var(--bg-primary)" }}>
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6">
        <section className="py-20 sm:py-28" style={{ borderBottom: "1px solid var(--border)" }}>
          ...
          >
            For California Wholesale Distributors
          </span>
          <h1
            className="font-serif text-4xl sm:text-5xl lg:text-6xl font-normal leading-[1.1] mb-6 max-w-3xl"
            style={{ color: "var(--text-headline)" }}
          >
            California&apos;s distribution market moves fast. Your clients are ordering from competitors who make it easier.
            <br />
            <span style={{ color: "var(--blue)" }}>Give them a portal that works as hard as you do.</span>
          </h1>
          <p
            className="font-mono text-sm leading-relaxed max-w-xl mb-10"
            style={{ color: "var(--text-body)" }}
          >
            Wholesail builds custom B2B ordering portals for California wine, produce, specialty food, and beverage
          ...
          <p
            ...
            style={{ color: "var(--text-muted)" }}
          >
            California has the largest wholesale distribution market in the US — and the highest competition for every account.
          </p>
        </section>
        ...
        <section className="py-16" style={{ borderBottom: "1px solid var(--border)" }}>
          ...
          >
            ...
            <blockquote
              ...
              style={{ color: "var(--text-body)" }}
            >
              We distribute specialty and artisan foods to about 120 restaurants and retailers across the Bay Area. Before Wholesail, half our orders came in as texts or voicemails and someone had to decode them Monday morning. Now every account has their own portal with their pricing built in. Order errors went to basically zero and our rep is doing actual selling instead of order entry.
            </blockquote>
            <div>
              <div className="font-mono text-[11px] font-semibold" style={{ color: "var(--text-headline)" }}>Elena R.</div>
              <div className="font-mono text-[10px]" style={{ color: "var(--text-muted)" }}>Bay Provisions Co.</div>
              <div className="font-mono text-[9px] uppercase tracking-wider mt-1" style={{ color: "var(--text-muted)" }}>Specialty Food Distribution — Northern California</div>
            </div>
          </div>
        </section>
